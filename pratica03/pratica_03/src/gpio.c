 ...
 * =====================================================================================
 */
void gpioInitModule(gpioPort port){ //port = 1
	if(gpioCheckValidPortPin(port, 0)){  // pin 0 always exist
    		unsigned int setting = (1<<18) | (0x2<<0);   //enable functional clock & enable module, TRM 8.1.12.1.29 //0b00000000000001000000000000000010
      		switch(port){
        		case GPIO0:
 ...
 * =====================================================================================
 */
void gpioPinMuxSetup(gpioPort port, ucPinNumber pin, pinDirection dir){ //1  21-25  0
